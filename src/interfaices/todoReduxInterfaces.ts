...
export type Additem = IAction<TodoActionType.ADD_ITEM, ITodoItem>;
...
export type DeleteItem = IAction<TodoActionType.DELETE_ITEM, ITodoItem>;
...
export type DeleteCompletedSuccess = IAction<
  ...
  ITodoItem[]
>;
export type DeleteCompleted = IAction<
  TodoActionType.DELETE_COMPLETED,
  ITodoItem[]
>;
...
export type ToggleAllSuccess = IAction<
  ...
  boolean
>;
export type ToggleAll = IAction<TodoActionType.TOGGLE_ALL, boolean>;
...
export type ChangeItemCheck = IAction<
...
export type ChangeItemValue = IAction<
